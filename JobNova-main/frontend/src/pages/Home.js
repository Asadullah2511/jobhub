            ...
            <div className="hero-wrapper">
                <header className="hero-section">
                    <div className="hero-content">
                        <h1 className="hero-title">{t('heroTitle') || "Empowering Your Career Journey"}</h1>
                        <p className="hero-subtitle">{t('heroSubtitle') || "Connect with the right opportunities. Whether you're building a professional career or offering skilled services, JobNova brings the jobs to you."}</p>
